...
window.plugin.portalslist.exportCSV = function(){
   ...
   //headers
    csv += 'Portal' + sep + 'Level' + sep + 'Team' + sep + 'R1' + sep + 'R2' + sep + 'R3' + sep + 'R4' + sep + 'R5' + sep + 'R6' + sep + 'R7' + sep + 'R8' + sep + 'Energy' + sep + 'S1' + sep + 'S2' + sep + 'S3' + sep + 'S4' + sep + 'AP Gain' + sep + 'E/AP' + sep + 'lat' + sep + 'long\n';
    ...
    $.each(portals, function(ind, portal) {
        ...
        if (filter === 0 || filter === portal.team){
            ...
            $.each([0, 1, 2, 3 ,4 ,5 ,6 ,7], function(ind, slot) {
                csv += portal.resonators[slot][0] + sep;
            });
            
            csv += portal.energyratio + sep + portal.shields[0][0] + sep + portal.shields[1][0] + sep + portal.shields[2][0] + sep + portal.shields[3][0] + sep + portal.APgain + sep + portal.EAP + sep;
            csv += portal.lat + sep + portal.lng;
            csv += '\n';
        }  
    });
