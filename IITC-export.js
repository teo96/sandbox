// ==UserScript==
// @id             ingress-intel-total-conversion-export@teo96
// @name           IITC Export
...
window.chat.renderMsg = function(msg, nick, time, team) {
  ...
  //console.log(tb + '\t' + nick + '\t' + msg);
  // help cursor via “#chat time”
  //var t = '<time title="'+tb+'" data-timestamp="'+time+'">'+ta+'</time>';
  //var s = 'style="color:'+COLORS[team]+'"';
  //var title = nick.length >= 8 ? 'title="'+nick+'" class="help"' : '';
  //var i = ['<span class="invisep">lt;</span>', '<span class="invisep">&gt;</span>'];
  var i = ['<span class="invisep"> </span>', '<span class="invisep"> </span>'];
  return '<tr><td>'+tb+'</td><td width=60px>'+nick+'</td><td width=15px>'+team+'</td><td>'+msg+'</td></tr>';
}
